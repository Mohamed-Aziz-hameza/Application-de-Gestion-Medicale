...
import { FaUser, FaEnvelope, FaPhone, FaLock, FaCalendarAlt, FaMapMarkerAlt, FaEye, FaEyeSlash } from "react-icons/fa";
...
const PatientRegister: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("Inscription réussie ! (à remplacer par la vraie logique)");
